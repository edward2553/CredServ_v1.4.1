            ...
            <ul class="list-unstyled components">
                ...
                <li  <%=usuario.getNivel() == 2 ? "hidden" : ""%> >
                    ...
                    <ul class="collapse list-unstyled" id="parametrizacionesSubMenu">
                        ...
                        <li> 
                            <a href="../parametrizaciones/prm_vehiculos.jsp">Parametrizar vehiculo</a>
                        </li>
                        <li> 
                 ...
                 <li>
                    ...
                    <ul class="collapse list-unstyled" id="informesSubMenu">
                        <li> 
                            <a href="informes.jsp">Realizar un informe</a>
                        </li>
                        <li> 
                            <a href="consultar_informe.jsp">Consultar un informe</a>
                        </li>
                    </ul>
                </li> 
                <li >
